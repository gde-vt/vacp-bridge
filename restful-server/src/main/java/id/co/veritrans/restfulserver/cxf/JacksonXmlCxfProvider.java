...
public class JacksonXmlCxfProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object> {

    private JacksonXMLProvider jacksonDelegate;

    public JacksonXmlCxfProvider() {
    }

    public JacksonXMLProvider getJacksonDelegate() {
        return jacksonDelegate;
    }

    public void setJacksonDelegate(JacksonXMLProvider jacksonDelegate) {
